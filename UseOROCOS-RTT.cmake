...
if(OROCOS-RTT_FOUND AND NOT USE_OROCOS_RTT)
  ...
  macro( _orocos_target target target_type )
    ...
    set_target_properties( ${target} PROPERTIES
      ...
      INSTALL_RPATH "${CMAKE_INSTALL_PREFIX}/lib/orocos${OROCOS_SUFFIX}/${PROJECT_NAME};${CMAKE_INSTALL_PREFIX}/lib/orocos${OROCOS_SUFFIX}/${PROJECT_NAME}/types;${CMAKE_INSTALL_PREFIX}/lib/orocos${OROCOS_SUFFIX}/${PROJECT_NAME}/plugins;${CMAKE_INSTALL_PREFIX}/lib;${CMAKE_INSTALL_PREFIX}/${_orocos_target_LIBRARY_DESTINATION}"
    )
    if(APPLE)
